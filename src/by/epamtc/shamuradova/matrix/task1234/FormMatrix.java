package by.epamtc.shamuradova.matrix.task1234;

import by.epamtc.shamuradova.matrix.PrinterMatrix;
import by.epamtc.shamuradova.matrix.task5.MatrixOperations;
...
public class FormMatrix {
    ...
    public static void main(String[] args) {
        ...
        int[][] newMatrix = FormMatrix.formMatrix1(matrix);
        int[][] newMatrix2 = FormMatrix.formMatrix2(matrix);
        int[][] newMatrix3 = FormMatrix.formMatrix3(matrix);
        PrinterMatrix.arrayPrint(newMatrix);
        PrinterMatrix.arrayPrint(newMatrix2);
         PrinterMatrix.arrayPrint(newMatrix3);


        double[][] matrix4 = FormMatrix.formMatrix4(new double[]{1, 2, 3, 4, 5});
